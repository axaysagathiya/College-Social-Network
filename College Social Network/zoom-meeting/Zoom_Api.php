...
class Zoom_Api
{
	private $zoom_api_key = 'GVLVFiFbSvaPIfIW4CVWNA';
	private $zoom_api_secret = '8scHA2KN8RrzH3OmZfSaH0rO5phlEBPeoj9E';	
	...
	//function to send request
    	...
    	{
		//Enter_Your_Email
		$request_url = "https://api.zoom.us/v2/users/axaysagathiya@gmail.com/meetings";
