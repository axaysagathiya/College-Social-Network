...
* [#1046](https://github.com/ckeditor/ckeditor4/issues/1046): Fixed: Subsequent new links do not require the `id` attribute. Thanks to [Nathan Samson](https://github.com/nathansamson)!
...
* [#1287](https://github.com/ckeditor/ckeditor4/issues/1287): Fixed: [Widget](https://ckeditor.com/cke4/addon/widget) plugin throws exception if required in editor build but not loaded into editor's instance.
